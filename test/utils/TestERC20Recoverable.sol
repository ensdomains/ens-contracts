...
contract TestERC20Recoverable is Test {
    ...
    function setUp() public {
        ...
        erc20Token = new MockERC20("Ethereum Name Service Token", "ENS", new address[](0));
    ...
    function testShouldRecoverERC20Token() public {
        ...
        assertEq(erc20Token.balanceOf(address(erc20Recoverable)), 1000, "Contract should have 1000 tokens");
        
        // Recover the funds to account0 (accounts[0].address)
        erc20Recoverable.recoverFunds(address(erc20Token), account0, 1000);
        
        // Verify recovery worked
        assertEq(erc20Token.balanceOf(address(erc20Recoverable)), 0, "Contract should have 0 tokens after recovery");
    }

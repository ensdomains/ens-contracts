...
library ENSTestConstants {
    ...
    bytes32 constant ETH_NODE = 0x93cdeb708b7545dc668eb9280176169d1c33cfd8ed6f04690a0bcc88a93fc4ae; // keccak256(abi.encodePacked(ROOT_NODE, ETH_LABEL))
    
    // Reverse domain constants
    bytes32 constant REVERSE_LABEL = keccak256("reverse");
    bytes32 constant REVERSE_NODE = 0xa097f6721ce401e757d1223a763fef49b8b5f90bb18567ddb86fd205dff71d34; // keccak256(abi.encodePacked(ROOT_NODE, REVERSE_LABEL))
    bytes32 constant ADDR_LABEL = keccak256("addr");
    bytes32 constant ADDR_REVERSE_NODE = 0x91d1777781884d03a6757a803996e38de2a42967fb37eeaca72729271025a9e2; // keccak256(abi.encodePacked(REVERSE_NODE, ADDR_LABEL))
    
    // Other common TLDs
    bytes32 constant XYZ_LABEL = keccak256("xyz");
    bytes32 constant XYZ_NODE = 0x9dd2c369a187b4e6b9c402f030e50743e619301ea62aa4c0737d4ef7e10a3d49; // keccak256(abi.encodePacked(ROOT_NODE, XYZ_LABEL))

...
contract TestHexUtilsTest is BaseTest {
    ...
    function testHexStringToBytes32() public view {
        ...
        (bytes32 result, bool valid) = hexUtils.hexStringToBytes32(
            bytes("5cee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da"),
            0,
            64
        );
        assertEq(
        ...
        (result, valid) = hexUtils.hexStringToBytes32(
            bytes("zcee339e13375638553bdf5a6e36ba80fb9f6a4f0783680884d92b558aa471da"),
            0,
            64
        );
    ...
    function testAddressToHex() public view {
        ...
        assertEq(result, "0000000000000000000000000000000000000000", "Zero address conversion failed");
        
        // Test specific address
        result = hexUtils.addressToHex(0x5ceE339e13375638553bdF5a6e36BA80fB9f6a4F);
        assertEq(result, "5cee339e13375638553bdf5a6e36ba80fb9f6a4f", "Address conversion failed");
    }

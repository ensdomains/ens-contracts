...
contract TestReverseClaimer is Test {
    ...
    bytes32 constant REVERSE_NODE =
        keccak256(abi.encodePacked(ZERO_HASH, keccak256("reverse")));
    bytes32 constant ADDR_NODE =
    ...
    function testClaimsReverseNodeToMsgSenderOfDeployer() public {
        ...
        assertEq(
            owner,
            address(this),
            "Deployer should own the reverse name when specified as claimant"
        );
    }
    ...
    function testMultipleReverseClaimersCanClaimIndependently() public {
        ...
        assertEq(
            ens.owner(reverseNode1),
            USER1,
            "First implementer should have USER1 as reverse owner"
        );
        assertEq(
            ens.owner(reverseNode2),
            USER2,
            "Second implementer should have USER2 as reverse owner"
        );
    }

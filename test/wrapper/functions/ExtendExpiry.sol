...
contract ExtendExpiry is Test {
    ...
    function testExtendExpiryByParentOwner() public {
        ...
        assertEq(
            initialExpiry,
            parentExpiry - 3600,
            "Initial expiry should be parentExpiry - 3600"
        );
        ...
        assertEq(
            ...
            "New expiry should be parent expiry + grace period"
        );
    ...
    function testCannotExtendExpiryByUnauthorized() public {
        ...
        bytes32 childNode = keccak256(
            abi.encodePacked(TEST_NODE, CHILD_LABEL_HASH)
        );
        vm.expectRevert(
    ...
    function testExtendExpiryNormalizesToParentExpiry() public {
        ...
        nameWrapper.extendExpiry(
            TEST_NODE,
            CHILD_LABEL_HASH,
            uint64(parentExpiry + baseRegistrar.GRACE_PERIOD() + 1)
        );
        ...
        assertEq(
            newExpiry,
            parentExpiry + baseRegistrar.GRACE_PERIOD(),
            "Expiry should be capped at parent expiry + grace period"
        );
    ...
    function testExtendExpiryToSpecificTime() public {
        ...
        assertEq(
            newExpiry,
            targetExpiry,
            "Expiry should be set to target time"
        );
    ...
    function testExtendExpiryEmitsEvent() public {
        ...
        emit ExpiryExtended(
            CHILD_NODE,
            uint64(parentExpiry + baseRegistrar.GRACE_PERIOD())
        );
    ...
    function testExtendExpiryByParentOwnerWithCanExtendExpiryBurned() public {
        ...
        // Check initial state
        (, uint32 initialFuses, uint64 initialExpiry) = nameWrapper.getData(
            CHILD_NODE_ID
        );
        assertEq(
            initialFuses,
            PARENT_CANNOT_CONTROL | CANNOT_UNWRAP | CAN_EXTEND_EXPIRY,
            "Initial fuses incorrect"
        );
        assertEq(
            initialExpiry,
            parentExpiry - 3600,
            "Initial expiry incorrect"
        );
    ...
    function testExtendExpiryByParentOwnerWithSameChildOwnerAndCanExtendExpiryBurned()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testExtendExpiryByApprovedOperatorOfParentOwnerWithoutCanExtendExpiry()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testExtendExpiryByApprovedOperatorOfParentOwnerWithCanExtendExpiry()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testCannotExtendExpiryByChildOwnerWithoutCanExtendExpiryBurned()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testCannotExtendExpiryByApprovedOperatorOfChildOwnerWithoutCanExtendExpiry()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testExtendExpiryByApprovedOperatorOfChildOwnerWithCanExtendExpiry()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testExtendExpiryByChildOwnerOfNonEmancipatedName() public {
        ...
        assertEq(
            initialFuses,
            CAN_EXTEND_EXPIRY,
            "Initial fuses should be CAN_EXTEND_EXPIRY"
        );
        assertEq(
            initialExpiry,
            parentExpiry - 3600,
    ...
    function testCannotExtendExpiryIfEmancipatedChildNameHasExpiredChildOwner()
        public
    {
        vm.startPrank(OWNER);
        ...
        assertEq(
            initialFuses,
            PARENT_CANNOT_CONTROL | CAN_EXTEND_EXPIRY,
            "Initial fuses should include PCC and CAN_EXTEND_EXPIRY"
        );
        assertEq(
            initialExpiry,
            childExpiry,
            "Initial expiry should match child expiry"
        );
    ...
    function testCannotExtendExpiryIfEmancipatedChildNameHasExpiredParentOwner()
        public
    {
        vm.startPrank(OWNER);
        ...
        (owner, initialFuses, initialExpiry) = nameWrapper.getData(
            CHILD_NODE_ID
        );
        ...
        assertEq(
            initialFuses,
            PARENT_CANNOT_CONTROL,
            "Initial fuses should include PCC"
        );
        assertEq(
            initialExpiry,
            childExpiry,
    ...
    function testExpiryIsNotNormalizedToNewValueIfBetweenOldExpiryAndParentExpiry()
        public
    {
        vm.startPrank(OWNER);
        ...
        assertEq(
            initialFuses,
            PARENT_CANNOT_CONTROL | CANNOT_UNWRAP | CAN_EXTEND_EXPIRY,
            "Initial fuses should include PCC, CANNOT_UNWRAP, and CAN_EXTEND_EXPIRY"
        );
        assertEq(
            initialExpiry,
            parentExpiry - 3600,
        ...
        assertEq(
            newExpiry,
            targetExpiry,
            "Expiry should be set to exact target value (parentExpiry - 1800)"
        );

        vm.stopPrank();
    }

    function testCannotExtendExpiryByParentOwnerIfEth2LDExpiredButGracePeriodNotEnded()
        public
    {
        vm.startPrank(OWNER);
        ...
        assertEq(
            initialFuses,
            PARENT_CANNOT_CONTROL | CANNOT_UNWRAP,
            "Initial fuses should include PCC and CANNOT_UNWRAP"
        );
        assertEq(
            initialExpiry,
            parentExpiry + baseRegistrar.GRACE_PERIOD() - 3600,
            "Initial expiry should be parentExpiry + grace period - 3600"
        );
    ...
    function testAllowsChildOwnerToSetExpiryIfParentEth2LDExpiredButGracePeriodNotEnded()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testCannotExtendExpiryByChildOwnerIfNonEmancipatedChildNameReachedExpiry()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testAllowsParentOwnerToSetExpiryIfNonEmancipatedChildNameReachedExpiry()
        public
    {
        vm.startPrank(OWNER);
        ...
        // Check that expiry was extended correctly
        (address owner, uint32 newFuses, uint64 newExpiry) = nameWrapper
    ...
    function testCannotExtendExpiryOfUnregisteredNameNotRegisteredEver()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testCannotExtendExpiryOfUnregisteredNameExpiredWithPCCBurnt()
        public
    {
        vm.startPrank(OWNER);
    ...
    function testAllowExtendExpiryOnWrappedNames() public {
        ...
        assertEq(
            newFuses,
            0,
            "Fuses should be reset to 0 after expiry and extension"
        );
        assertEq(
            newExpiry,
            parentExpiry + baseRegistrar.GRACE_PERIOD(),
    ...
    function testCannotExtendExpiryOfUnwrappedNames() public {
        ...
        assertEq(
            ...
            OWNER,
            "ENS registry should show OWNER as owner"
        );

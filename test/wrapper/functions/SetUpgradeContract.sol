...
contract SetUpgradeContract is Test {
    ...
    function testSetUpgradeContractByOwner() public {
        ...
        assertFalse(
            ...
            "Registrar should not be approved initially"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Registry should not be approved initially"
        );
        ...
        assertTrue(
            ...
            "Registrar should be approved for upgrade contract"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Registry should be approved for upgrade contract"
        );
    ...
    function testSetUpgradeContractRevokesOldApprovals() public {
        ...
        assertTrue(
            ...
            "Initial contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Initial contract should be approved"
        ...
        nameWrapper.setUpgradeContract(
            INameWrapperUpgrade(NEW_UPGRADE_CONTRACT)
        );
        ...
        assertFalse(
            ...
            "Old contract should not be approved"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Old contract should not be approved"
        ...
        assertTrue(
            ...
            "New contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), NEW_UPGRADE_CONTRACT),
            "New contract should be approved"
        );
    ...
    function testSetUpgradeContractToZeroAddress() public {
        ...
        assertTrue(
            ...
            "Contract should be approved initially"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Contract should be approved initially"
        ...
        assertFalse(
            baseRegistrar.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved"
        );
    ...
    function testSetUpgradeContractMultipleTimes() public {
        ...
        assertTrue(
            ...
            "First contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "First contract should be approved"
        ...
        assertFalse(
            ...
            "First contract should not be approved"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "First contract should not be approved"
        ...
        assertTrue(
            ...
            "Second contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), NEW_UPGRADE_CONTRACT),
            "Second contract should be approved"
        ...
        assertFalse(
            ...
            "Second contract should not be approved"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), NEW_UPGRADE_CONTRACT),
            "Second contract should not be approved"
        ...
        assertTrue(
            baseRegistrar.isApprovedForAll(address(nameWrapper), DUMMY_ADDRESS),
            "Third contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), DUMMY_ADDRESS),
            "Third contract should be approved"
        );
    ...
    function testSetUpgradeContractSameAddress() public {
        ...
        assertTrue(
            ...
            "Contract should still be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Contract should still be approved"
    ...
    function testSetUpgradeContractWithActiveNames() public {
        ...
        assertTrue(
            ...
            "Registrar should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Registry should be approved"
        );
        ...
        assertTrue(
            nameWrapper.isWrapped(testNode),
            "Domain should still be wrapped"
        );
        assertEq(
            nameWrapper.ownerOf(testNodeId),
            OWNER,
    ...
    function testSetUpgradeContractEffectOnExistingApprovals() public {
        ...
        assertTrue(
            ens.isApprovedForAll(OWNER, DUMMY_ADDRESS),
            "Other approvals should exist"
        );
        assertTrue(
            baseRegistrar.isApprovedForAll(OWNER, DUMMY_ADDRESS),
            "Other approvals should exist"
        );
        ...
        assertTrue(
            ...
            "Upgrade contract should be approved"
        );
        assertTrue(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Upgrade contract should be approved"
        ...
        assertTrue(
            ens.isApprovedForAll(OWNER, DUMMY_ADDRESS),
            "Other approvals should be unaffected"
        );
        assertTrue(
            baseRegistrar.isApprovedForAll(OWNER, DUMMY_ADDRESS),
            "Other approvals should be unaffected"
    ...
    function testSetUpgradeContractZeroAddressDoesNotSetApproval() public {
        ...
        assertFalse(
            baseRegistrar.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved initially"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved initially"
        ...
        assertFalse(
            baseRegistrar.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved after setting"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), address(0)),
            "Zero address should not be approved after setting"
    ...
    function testSetUpgradeContractFromZeroAddress() public {
        ...
        assertFalse(
            ...
            "Upgrade contract should not be approved yet"
        );
        assertFalse(
            ens.isApprovedForAll(address(nameWrapper), UPGRADE_CONTRACT),
            "Upgrade contract should not be approved yet"

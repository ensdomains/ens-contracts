...
contract SetRecord is BaseWrapperTest {
    ...
    function testSetRecordByOwner() public {
        ...
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), NEW_OWNER, "Owner should be transferred");
    ...
    function testSetRecordByOperator() public {
        ...
        // Check all record fields were set
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), NEW_OWNER, "Owner should be transferred by operator");
    ...
    function testSetRecordToSameOwner() public {
        ...
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), OWNER, "Owner should remain the same");
        assertEq(ens.resolver(TEST_NODE), RESOLVER, "Resolver should be set");
        assertEq(ens.ttl(TEST_NODE), newTTL, "TTL should be set");
    ...
    function testSetRecordWithZeroValues() public {
        ...
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), NEW_OWNER, "Owner should be transferred");
        assertEq(ens.resolver(TEST_NODE), address(0), "Resolver should be zero");
    ...
    function testCannotSetETH2LDOwnerToZero() public {
        ...
        vm.expectRevert(abi.encodeWithSignature("IncorrectTargetOwner(address)", address(0)));
    ...
    function testSetSubdomainOwnerToZeroUnwraps() public {
        ...
        assertEq(nameWrapper.ownerOf(SUB_NODE_ID), OWNER, "Should own subdomain");
        ...
        assertFalse(nameWrapper.isWrapped(SUB_NODE), "Subdomain should be unwrapped");
        assertEq(nameWrapper.ownerOf(SUB_NODE_ID), address(0), "Wrapper should not own subdomain");
    ...
    function testCannotSetSubdomainOwnerToZeroWithCannotUnwrapFuse() public {
        ...
        vm.expectRevert(abi.encodeWithSignature("OperationProhibited(bytes32)", SUB_NODE));
        nameWrapper.setRecord(SUB_NODE, address(0), RESOLVER, 3600);
    ...
    function testSetRecordPreservesUnchangedFields() public {
        ...
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), NEW_OWNER, "Owner should be changed");
        assertEq(ens.resolver(TEST_NODE), address(0x123), "Resolver should be preserved");
    ...
    function testSetRecordUpdatesAllFields() public {
        ...
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), NEW_OWNER, "Owner should be updated");
        assertEq(ens.resolver(TEST_NODE), newResolver, "Resolver should be updated");
    ...
    function testSetRecordTransfersToken() public {
        ...
        assertEq(nameWrapper.balanceOf(NEW_OWNER, TEST_NODE_ID), 0, "NEW_OWNER should not have token");

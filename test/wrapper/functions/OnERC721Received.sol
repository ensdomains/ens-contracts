...
contract OnERC721Received is Test {
    ...
    function testOnERC721ReceivedWrapsAndSetsOwner() public {
        ...
        bytes memory data = _encodeExtraData(
            TEST_LABEL,
            NEW_OWNER,
            0,
            address(0)
    ...
    function testOnERC721ReceivedEmitsEvents() public {
        ...
        uint256 expectedExpiry = baseRegistrar.nameExpires(TEST_LABEL_ID) +
    ...
    function testOnERC721ReceivedSetsCorrectExpiry() public {
        ...
        assertEq(
            ...
            "Expiry should be registrar expiry + grace period"
        );
    ...
    function testOnERC721ReceivedResetsExpiredFuses() public {
        ...
        assertEq(
            nameWrapper.ownerOf(TEST_NODE_ID),
            address(0),
            "Owner should be zero for expired domain"
        );

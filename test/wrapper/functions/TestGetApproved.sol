...
contract GetApproved is BaseWrapperTest {
    ...
    function testGetApprovedReturnsZeroForUnmintedToken() public view {
        ...
        assertEq(nameWrapper.getApproved(UNMINTED_NODE_ID), address(0), "Unminted token should have zero approved");
    }
    ...
    function testGetApprovedReturnsApprovedAddress() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), APPROVED, "Should return approved address");
    ...
    function testGetApprovedAfterApprovalChange() public {
        ...
        nameWrapper.approve(APPROVED, TEST_NODE_ID);
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), APPROVED, "Should return first approved address");
        
        // Change approval
        nameWrapper.approve(OTHER, TEST_NODE_ID);
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), OTHER, "Should return new approved address");
    ...
    function testGetApprovedAfterApprovalCleared() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), address(0), "Should return zero address after clearing");
    ...
    function testGetApprovedAfterTransfer() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), address(0), "Approval should be cleared after transfer");
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), OTHER, "OTHER should be new owner");
    ...
    function testGetApprovedAfterUnwrap() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), address(0), "Approval should be cleared after unwrap");
        assertEq(nameWrapper.ownerOf(TEST_NODE_ID), address(0), "Token should be burned after unwrap");
    ...
    function testGetApprovedMultipleTokens() public {
        ...
        nameWrapper.wrapETH2LD(label2, OWNER, uint16(CAN_DO_EVERYTHING), address(0));
        ...
        // Check each approval
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), APPROVED, "First token should be approved to APPROVED");
        assertEq(nameWrapper.getApproved(node2Id), OTHER, "Second token should be approved to OTHER");
    ...
    function testGetApprovedWithApprovalForAll() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), address(0), "getApproved should return zero even with approval for all");
        
        // But isApprovedForAll should return true
        assertTrue(nameWrapper.isApprovedForAll(OWNER, OTHER), "Should be approved for all");
    ...
    function testGetApprovedWithBothApprovals() public {
        ...
        assertEq(nameWrapper.getApproved(TEST_NODE_ID), APPROVED, "Should return specific approval");
        assertTrue(nameWrapper.isApprovedForAll(OWNER, OTHER), "Should also be approved for all");

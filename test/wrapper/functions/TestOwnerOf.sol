...
contract OwnerOf is BaseWrapperTest {
    ...
    function testOwnerOfAfterTransfer() public {
        ...
        assertEq(
            nameWrapper.ownerOf(TEST_NODE_ID),
            NEW_OWNER,
            "Should return new owner after transfer"
        );
    ...
    function testOwnerOfAfterUnwrap() public {
        ...
        assertEq(
            nameWrapper.ownerOf(TEST_NODE_ID),
            address(0),
            "Should return zero after unwrap"
        );
    ...
    function testOwnerOfSubdomain() public {
        ...
        bytes32 childNode = keccak256(
            abi.encodePacked(TEST_NODE, childLabelHash)
        );
        ...
        assertEq(
            nameWrapper.ownerOf(childNodeId),
            NEW_OWNER,
            "Subdomain should be owned by NEW_OWNER"
        );
    ...
    function testOwnerOfExpiredSubdomain() public {
        ...
        assertEq(
            nameWrapper.ownerOf(childNodeId),
            NEW_OWNER,
            "Subdomain should be owned initially"
        );
        ...
        assertEq(
            nameWrapper.ownerOf(childNodeId),
            dataOwner,
            "ownerOf should match getData owner for consistency"
        );
    ...
    function testOwnerOfEmancipatedSubdomain() public {
        ...
        assertEq(
            nameWrapper.ownerOf(childNodeId),
            NEW_OWNER,
            "Emancipated subdomain should be owned by NEW_OWNER"
        );
    ...
    function testOwnerOfAfterReWrap() public {
        ...
        assertEq(
            nameWrapper.ownerOf(TEST_NODE_ID),
            NEW_OWNER,
            "Should return NEW_OWNER after re-wrap"
        );
    ...
    function testOwnerOfMultipleTokens() public {
        ...
        assertEq(
            ...
            NEW_OWNER,
            "Second token should be owned by NEW_OWNER"
        );
    ...
    function testOwnerOfWithBalanceCheck() public {
        ...
        assertEq(
            ...
            1,
            "Owner should have balance of 1"
        );
        assertEq(
            nameWrapper.balanceOf(NEW_OWNER, TEST_NODE_ID),
            0,
            "Non-owner should have balance of 0"
        );
        ...
        assertEq(
            nameWrapper.ownerOf(TEST_NODE_ID),
            NEW_OWNER,
            "Should return new owner"
        );
        assertEq(
            nameWrapper.balanceOf(OWNER, TEST_NODE_ID),
            0,
            "Old owner should have balance of 0"
        );
        assertEq(
            nameWrapper.balanceOf(NEW_OWNER, TEST_NODE_ID),
            1,
            "New owner should have balance of 1"
        );

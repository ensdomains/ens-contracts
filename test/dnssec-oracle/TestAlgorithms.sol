...
contract TestAlgorithms is Test {
    ...
    function testRSASHA1AlgorithmShouldReturnTrueForValidSignatures() public {
        ...
        bytes memory publicKey = hex"";
    ...
    function testRSASHA1AlgorithmShouldReturnFalseForInvalidSignatures() public {
        RSASHA1Algorithm algorithm = new RSASHA1Algorithm();
        
        bytes memory publicKey = hex"";
        // Modify signed data by appending 00 to make it invalid
        bytes memory invalidSignedData = hex"00060701000003845af561bf5ad9a42f0746036f726700036f72670000060001000003840043026130036f72670b6166696c6961732d6e737404696e666f00036e6f630b6166696c6961732d6e737404696e666f0077fb3b8b000007080000038400093a800001518000";
        bytes memory signature = hex"";
    ...
    function testRSASHA256AlgorithmShouldReturnTrueForValidSignatures() public {
        ...
        bytes memory publicKey = hex"0100030803010001c15c1ac6b1c5d822bae1a60a45489b2e21f7d0aa4fb8f0637a5ec4f19c9d416d476161dfa069a27730b6467870082dbdde10b3c3e4c54769ea9fc395498e6dd9";
    ...
    function testRSASHA256AlgorithmShouldReturnFalseForInvalidSignatures() public {
        RSASHA256Algorithm algorithm = new RSASHA256Algorithm();
        
        bytes memory publicKey = hex"0100030803010001c15c1ac6b1c5d822bae1a60a45489b2e21f7d0aa4fb8f0637a5ec4f19c9d416d476161dfa069a27730b6467870082dbdde10b3c3e4c54769ea9fc395498e6dd9";
        // Modify signed data by appending 00 to make it invalid
        bytes memory invalidSignedData = hex"0001080300000e1070dbd880386d43802349076578616d706c65036e65740003777777076578616d706c65036e6574000001000100000e100004c000025b00";
        bytes memory signature = hex"91108e1fabbb974406cbdaa90bd975b0b9dc25c38a14b27b1a18943a26eee2d798a79544f519dcae24a164dcfce66c2532034469c1582bf94fb4f89560fe1bc2";
    ...
    function testP256SHA256AlgorithmShouldReturnTrueForValidSignatures() public {
    ...
    function testP256SHA256AlgorithmShouldReturnFalseForInvalidSignatures() public {
        P256SHA256Algorithm algorithm = new P256SHA256Algorithm();
        
        bytes memory publicKey = hex"0101030d1a88c88615d437fbb8bf9e1942a1929f28562706ae6c2bd399e7b1bfb6d1e9e75b92b4aa42917ae1c61b701ef035c3fe7be3009cbafe5a2f71316c902dcf0d00";
        // Modify signed data by appending 00 to make it invalid
        bytes memory invalidSignedData = hex"00010d0300000e104c88b1374c63c737d960076578616d706c65036e65740003777777076578616d706c65036e6574000001000100000e100004c000020100";
        bytes memory signature = hex"ab1eb02d8aa687e97da0229337aa8873e6f0eb26be289f28333d183f5d3b7a95c0c869adfb748daee3c5286eed6682c12e5533186baced9c26c167a9ebae950b";

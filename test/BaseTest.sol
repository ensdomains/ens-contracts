...
abstract contract BaseTest is Test {
    ...
    bytes32 public constant ADDR_REVERSE_NODE =
        ENSTestConstants.ADDR_REVERSE_NODE;

    uint256 public constant DAY = ENSTestConstants.DAY;
    uint256 public constant REGISTRATION_TIME =
        ENSTestConstants.REGISTRATION_TIME;
    uint256 public constant BUFFERED_REGISTRATION_COST =
    ...
    function _deployContractsLocally() internal {
        ...
        root.setSubnodeOwner(
            ENSTestUtils.labelhash("reverse"),
            TestAccounts.owner()
        );
        ens.setSubnodeOwner(
            REVERSE_NODE,

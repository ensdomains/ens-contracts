...
contract TestStaticBulkRenewal is Test {
    ...
    function setUp() public {
        ...
        bulkRenewal = new StaticBulkRenewal(
            ETHRegistrarController(address(mockController))
        );
    ...
    function testSetupWorks() public view {
        ...
        assertTrue(
            address(mockController) != address(0),
            "Mock controller should be deployed"
        );
    }
    ...
    function testShouldReturnCostOfBulkRenewal() public view {
        ...
        assertEq(
            cost,
            duration * 2,
            "Bulk renewal cost should be duration * number of names"
        );
    }
    ...
    function testShouldRaiseErrorRenewingNonexistentName() public {
        ...
        vm.expectRevert();
        bulkRenewal.renewAll(names, duration, 0);
    }

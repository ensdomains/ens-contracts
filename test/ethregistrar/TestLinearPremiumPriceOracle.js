...
contract('LinearPremiumPriceOracle', function (accounts) {
    ...
    before(async () => {
        ...
        priceOracle = await LinearPremiumPriceOracle.new(dummyOracle.address, [0, 0, 4, 2, 1], premium, decreaseRate);
    });
    ...
    it('should return correct base prices', async () => {
        ...
        assert.equal((await priceOracle.price("foobie", 0, 3600)).toNumber(), 1800);
    });

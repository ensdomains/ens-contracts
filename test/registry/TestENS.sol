...
contract TestENS is BaseTest {
    ...
    function testShouldAllowOwnershipTransfers() public {
        ...
        assertEq(
            ens.owner(testNode),
            PLACEHOLDER_ADDR,
            "Owner should be set to placeholder address"
        );
    }
    ...
    function testShouldAllowSettingResolvers() public {
        ...
        assertEq(
            ens.resolver(testNode),
            PLACEHOLDER_ADDR,
            "Resolver should be set to placeholder address"
        );
    }
    ...
    function testShouldAllowTheCreationOfSubnodes() public {
        ...
        assertEq(
            ens.owner(childNode),
            account1,
            "Child subnode should be owned by account1"
        );
    }

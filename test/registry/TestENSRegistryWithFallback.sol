...
contract TestENSRegistryWithFallback is BaseTest {
    ...
    function testSetRecord() public {
        ...
        assertEq(ensRegistry.resolver(ZERO_HASH), USER2, "Resolver should be set");
    ...
    function testSetSubnodeRecord() public {
        ...
        assertEq(ensRegistry.owner(testNode), USER1, "Subnode owner should be set");
        assertEq(ensRegistry.resolver(testNode), USER2, "Subnode resolver should be set");
    ...
    function testApprovalForAll() public {
        ...
        assertEq(ensRegistry.owner(ZERO_HASH), USER2, "Approved operator should be able to set owner");
    }
    ...
    function testFallbackOwner() public {
        ...
        // Should read from fallback
        assertEq(ensRegistry.owner(ethNode), USER1, "Should use fallback owner");
    }
    ...
    function testFallbackResolver() public {
        ...
        // Should read from fallback
        assertEq(ensRegistry.resolver(ethNode), USER2, "Should use fallback resolver");
    }

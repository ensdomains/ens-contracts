...
contract TestFIFSRegistrar is Test {
    ...
    function testShouldAllowRegistrationOfNames() public {
        ...
        assertEq(ensRegistry.owner(ZERO_HASH), address(fifsRegistrar), "Root should be owned by registrar");
    ...
    function testShouldAllowTransferringNameToYourOwn() public {
        ...
        assertEq(ensRegistry.owner(namehash("eth")), account1, "ETH node should be owned by account1");
    }

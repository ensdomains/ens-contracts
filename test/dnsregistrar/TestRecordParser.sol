...
contract TestRecordParser is Test {
    ...
    function testParsesData() public view {
        ...
        (string memory name, string[] memory keys, string[] memory values, string memory url) = 
        ...
        assertTrue(keccak256(bytes(values[1])) != keccak256(bytes('18;https://tether.to')), "Should not include URL in value");
    ...
    function testValidatesInternalKeyValueParsingBehavior() public view {
        ...
        (string memory name1, string[] memory keys1, string[] memory values1, string memory url1) = 
        ...
        (string memory name2, string[] memory keys2, string[] memory values2, string memory url2) = 
        ...
        (string memory name3, string[] memory keys3, string[] memory values3, string memory url3) = 
    ...
    function testHandlesBoundaryConditionsInParsing() public view {
        ...
        string memory data2 = 'very_long_name_that_tests_boundaries;very_long_key_name=very_long_value_content_that_should_be_parsed_correctly;https://very-long-url-that-should-be-handled-properly.example.com';
        (string memory name2, string[] memory keys2, string[] memory values2, string memory url2) = 
            parser.parseData(bytes(data2), 1);
    ...
    function testValidatesParsingOffsetAndLengthCalculations() public view {
        ...
        string memory data2 = 'complex;short=x very_long_key=very_long_value medium=mid;https://example.com';
        (string memory name2, string[] memory keys2, string[] memory values2, string memory url2) = 

...
```mermaid
graph LR
	node{{node}}==>contract==>record(record)
	root{{root}}-.->reverse{{reverse}}
	root-.->eth{{eth}}
	eth-.->eth_raffy{{raffy.eth}}
	resolver_tor --o resolver_tor_raffy(addr&lpar;raffy.eth, 60&rpar; &rarr; 0x5105)
	...
	resolver_default --o default_0001(name&lpar;0001.default.reverse&rpar; &rarr; ghost.eth)
	...
	resolver_pr --o resolver_pr_5105(name&lpar;**5105.addr.reverse**&rpar; &rarr; raffy.eth)
    reverse_addr_5105-- resolver -->resolver_pr[PublicResolver]
    reverse_addr-.->reverse_addr_1234{{1234.addr.reverse}};
	resolver_pr --o resolver_pr_1234(name&lpar;**1234.addr.reverse**&rpar; &rarr; &lt;null&gt;)
	resolver_pr --o resolver_pr_ghost(addr&lpar;ghost.eth, 0x80000000&rpar; &rarr; 0x0001)
	...
	registrar_linea --o linea_5105(name&lpar;0x5105&rpar; &rarr; raffy.eth)
	registrar_linea --o linea_0001(name&lpar;0x0001&rpar; &rarr; ghost.linea.eth)
	registrar_base --o base_1234(name&lpar;0x5105&rpar; &rarr; raffy.base.eth)
	...
	linea_pr --o linea_pr_0001(addr&lpar;ghost.linea.eth, 0x8000e708&rpar; &rarr; 0x0002)
